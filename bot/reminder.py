    ...
    while True:
        ...
        for i in range(size):
            ...
            if now_obj == date_obj:
                ...
                func.print_log("Reminder: (" + reminders[i][1] + ", " + reminders[i][2] + ")", "Reminder notification: " + database.get_user_data(reminders[i][3])[0] + " (" + str(reminders[i][3]) + ").")
                ...
                bot.send_message(reminders[i][3], "🔔 *" + text1 + ":*\n\n" + text5 + "\n" + text6 + ": _" + reminders[i][2] + "_\n" + text7 + ": _" + reminders[i][1] + "_", parse_mode='Markdown')
                database.edit_notified_status(reminders[i][0], 1)
                func.print_log("Reminder: (" + reminders[i][1] + ", " + reminders[i][2] + ")", "Reminder delayed notification: " + database.get_user_data(reminders[i][3])[0] + " (" + str(reminders[i][3]) + ").")
